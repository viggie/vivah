...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="$url/vendor/bootstrap-4.2.1/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom fonts for this template -->
    <link href="$url/vendor/font-awesome-5.7/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Oswald:700|Roboto+Slab:300&display=swap" rel="stylesheet">
...
$html = <<<END
    ...
    <script src="$url/vendor/bootstrap-4.2.1/js/bootstrap.bundle.min.js"></script>
